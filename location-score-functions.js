...
function normalizeScore(rawScore, metric) {
    ...
    if (metric.higherIsBetter === false) {
        ...
        // Use target/achieved ratio (capped at 100%)
        score = Math.min(100, (target / rawScore) * 100);
    } else {
        // For metrics where higher is better
        // Use achieved/target ratio (capped at 100%)
        score = Math.min(100, (rawScore / target) * 100);
    }
