...
async function loadRealData() {
    ...
    currentScoreData = parseCSVData(dataText);
    benchmarkData = parseCSVData(benchmarkText);
    
    // Process and calculate scores
    currentScoreData = currentScoreData.map(clinic => ({
        ...clinic,
        ...calculateClinicScores(clinic)
    }));
    ...
    data.forEach(clinic => {
        ...
        row.innerHTML = `
            ...
            <td class="metric-value">
                <button class="action-button" onclick="showClinicDetails('${clinic.clinic}')">
                    View Details
                </button>
            </td>
        `;
